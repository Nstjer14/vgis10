\chapter{Problem Statement}\label{ch:prob_state}
...
\begin{itemize}
	...
	\item How can occlusions be detected in a sequence of images of zebrafish using computer vision? %How do we detect an occlusion in an image?
